...
const defaultFileBuildProcessing = ({ fileSrc, destinationFileSrc, modifyData = (data) => data }) => {
...
const mixInCustomPageOptions = ({ reqPath, config, originalCustomOptions, mode, optionsFileName }) => {
